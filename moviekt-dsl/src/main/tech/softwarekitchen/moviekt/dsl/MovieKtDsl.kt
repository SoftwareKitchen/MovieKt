...
fun movie(conf: DslVideoConfiguration.() -> Unit){
    ...
    val rootVideoClip = ContainerVideoClip("_", c.size, Vector2i(0,0),true)
    val rootAudioClip = AudioContainerClip(1)

    rootVideoClip.addChild(ColorVideoClip("_", c.size, Vector2i(0,0), true, ColorVideoClipConfiguration(Color.BLACK)))
...
fun DslChapterContainer.prepareChapters(target: VideoClip){
    ...
    chapters.forEach{
        ...
        chapterRoot.animationContainer().addRawAnimation(SetOnceAnimation(id, VideoClip.PropertyKey_Visible, 0f, true))
        chapterRoot.animationContainer().addRawAnimation(SetOnceAnimation(id, VideoClip.PropertyKey_Visible, chapterLength.toFloat(), false))
        ...
        it.scenes.forEach{
            ...
            sceneRoot.animationContainer().addRawAnimation(SetOnceAnimation(sid, VideoClip.PropertyKey_Visible, 0f, true))
            sceneRoot.animationContainer().addRawAnimation(SetOnceAnimation(sid, VideoClip.PropertyKey_Visible, it.length.toFloat(), false))
